export default function Sidebar() {
  return (
    <div class="min-h-screen w-full bg-gray-100 text-gray-700" x-data="layout">
      {/* <!-- header page --> */}
      ...
      <div class="flex">
        {/* <!-- aside --> */}
        <div
          class="flex w-72 flex-col space-y-2 border-r-2 border-gray-200 bg-white p-2 h-screen hideonmobilescreen"
          x-show="asideOpen"
        >
          <a
            href="#"
